  ...
  () => {
    ...
    after(
      async () => {
        ...
        /**
         * CUSTOMER_ACTION_SYNC_TEST_C5_CLEANUP
         */
    ...
    test(
      ...
      async () => {
        ...
        /**
         * CUSTOMER_ACTION_SYNC_TEST_T038
         */
        const syncChange =
  ...
  () => {
    ...
    after(
      async () => {
        ...
        /**
         * CUSTOMER_ACTION_SYNC_TEST_C6_CLEANUP
         */
        await prisma.syncChangeLog.deleteMany({
          where: {
            entityId: {
    ...
    test(
      ...
      async () => {
        ...
        /**
         * CUSTOMER_ACTION_SYNC_TEST_T041
         *
         * REJECT precisa publicar o snapshot final
         * CANCELADO para o Pull incremental.
         */
        const syncChange =
          await prisma.syncChangeLog.findFirst({
            where: {
...
describe(
  ...
  () => {
    ...
    async function createAndCompleteOrder(
      ...
      /**
       * CUSTOMER_ACTION_SYNC_TEST_APPROVE
       *
       * Tem de existir um NOVO ChangeLog posterior
       * ao AGUARDANDO_APROVACAO.
       */
      const approveChange =
        await prisma.syncChangeLog.findFirst({
          where: {
...
describe(
  ...
  () => {
    ...
    const adminEmail =
      `client-gate-admin-${runId}@assistailab.test`;

    const technicianEmail =
      `client-gate-tech-${runId}@assistailab.test`;

    const customerEmail =
      `client-gate-customer-${runId}@assistailab.test`;
    ...
    before(
      async () => {
        ...
        process.env.JWT_SECRET =
          'client-app-backend-gate-secret-2026';
      ...
      async () => {
        const response =
          await app.inject({
            ...
            url:
              `/api/v1/service-orders/${orderId}/status`,
     ...
     * ========================================================
     *
     * O writer de SyncChangeLog recebe o TransactionClient.
     * Se o commit falhar, nem a OS nem o ChangeLog podem
     * sobreviver isoladamente.
     */
    test(
      'T056 - ServiceOrder mutation and SyncChangeLog rollback atomically',
      async () => {
        const before =
          await prisma.serviceOrder.findUniqueOrThrow({
            where: {
        ...
        await assert.rejects(
          prisma.$transaction(
            async (
              ...
              throw new Error(
                'FORCED_SYNC_ATOMICITY_ROLLBACK'
              );
            }
          ),
          /FORCED_SYNC_ATOMICITY_ROLLBACK/
