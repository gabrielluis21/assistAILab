...
import {
  syncRoutes,
} from './modules/sync/sync.routes.js';
...
import {
  serviceOrderRoutes,
} from './modules/service_orders/service_orders.routes.js';
...
} from './modules/equipment_acquisitions/equipment_acquisitions.routes.js';
...
export function buildApp() {
  ...
  if (!jwtSecret) {
    throw new Error(
      'FATAL: JWT_SECRET environment variable is missing. App startup aborted.'
    );
  }
